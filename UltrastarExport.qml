...
MuseScore {
    ...
    Settings {
        ...
        property alias generateMp3: generateMp3.checked
    }
        ...
        contentItem: Rectangle {
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    Label {
                        text: qsTr("Enable MP3 Generation")
                    }
                    CheckBox {
                        id: generateMp3
                    }
    ...
    function exportTxtFile() {
        ...
        if (mscoreMajorVersion > 2) {
            // MuseScore 3 stores title as workTitle in a metaTag.
            title = curScore.metaTag("workTitle");
            // And composer is also a metaTag.
        ...
        var filename = exportDirectory.text + "//" + filenameFromScore() + ".txt"
        ...
        txtContent += "#MP3:"
        if (generateMp3.checked) {
            txtContent +=  filenameFromScore() + ".mp3" + crlf
        } else {
            txtContent += crlf
        }
